...
export const COMPANY_PROFILE = {
    ...
    values: [
        { title: "Excellence", description: "Delivering world-class services", icon: "award" },
        { title: "Integrity", description: "Building trust through transparency", icon: "shield-check" },
        { title: "Innovation", description: "Continuously improving our services", icon: "lightbulb" },
        { title: "Sustainability", description: "Promoting environmentally friendly practices", icon: "leaf" },
        { title: "Customer Care", description: "Putting our clients at the heart of everything we do", icon: "heart" }
    ],
    whyChooseUs: [
...
export const SPORT_PRICES = [
    { product: "SAUNA & STEAM", price: "5,000 Frw" },
    { product: "SWIMMING", price: "5,000 Frw" },
    { product: "GYM", price: "5,000 Frw" },
    { product: "JACUZZI", price: "20,000 Frw" },
...
export const BRANCH_DATA: Record<Branch, BranchData> = {
    [Branch.NDERA]: {
        ...
        location: { lat: -1.9441, lng: 30.0619, address: 'Near 15 Road, Ndera, Gasabo', distance: 'Flagship Location' },
        rooms: [
            {
                id: 'n-studio',
            ...
            },
            {
                ...
                amenities: ['Private Balcony', 'In-Suite Washer/Dryer', 'Bose Home Theater Sound System', 'Executive Work Desk', 'Nespresso & Tea Station', 'Mini Bar with Premium Selections', 'Rainfall Shower & Bathtub'],
        ...
        services: [
            {
                ...
                highlights: ['25-meter pool', 'Poolside cabanas', 'Evening ambiance'],
                inclusions: ['Towels', 'Loungers'],
                goodToKnow: ['Children must be supervised', 'Outside food/drinks restricted'],
                gallery: [
        ...
        rooms: [
            {
                ...
                amenities: ['Kitchenette', 'Work Desk', 'Laundry Service'],
        ...
        rooms: [
            {
                ...
                amenities: ['Weekly Housekeeping', 'Secure Parking', 'Water Heater'],
