...
describe('Gym Subscriptions Integration Tests', () => {
    ...
    let testBranchId;
    let testServiceId;
    let testServiceBookingId;
    let testGymSubscriptionId;
    ...
    it('should list gym subscriptions', async () => {
        ...
        expect(response.body.some((s) => s.id === testGymSubscriptionId)).toBe(true);
    });
...
//# sourceMappingURL=gym-subscriptions.integration-spec.js.map