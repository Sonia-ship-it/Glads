...
export class PaymentsController {
  ...
  @ApiOperation({
    ...
    description: 'Initiate payment via Pesapal gateway',
  })
  @ApiBody({ type: InitiatePaymentDto })
  @ApiResponse({
    status: 201,
    description: 'Payment initiated successfully. Returns redirect URL.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Handle payment gateway callback (IPN). Called by Pesapal.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Retrieve detailed payment information. Staff/Admin only.',
  })
  @ApiParam({ name: 'id', description: 'Payment ID', example: 'uuid-payment-id' })
